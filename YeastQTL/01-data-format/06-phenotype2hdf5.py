###limix_converter --outfile=Yeast-Phenotype.hdf5 -csv=Yeast-Phenotype.csv
###limix_converter --outfile=Yeast.hdf5 -csv=Yeast-Phenotype.csv

import pandas
import scipy as sp
import h5py
C = pandas.io.parsers.read_csv('Yeast-Phenotype.formated.txt',header=0,index_col=0,sep='\t')
